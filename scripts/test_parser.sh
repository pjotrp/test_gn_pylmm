...
env PYTHONPATH=$pylmm_lib_path:./lib python $pylmm_lib_path/convertlmm.py -v --kinship data/test_snps.132k.clean.noX.pylmm.kin --plink data/test_snps.132k.clean.noX.fake.phenos --geno data/test_snps.132k.clean.noX --prefix ./test
env PYTHONPATH=$pylmm_lib_path:./lib python $pylmm_lib_path/runlmm.py --kinship test.kin --pheno test.pheno --geno test.geno redis
